...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002347095058')
if len(LOG_CHANNEL) == 0:
    print('Error - LOG_CHANNEL is missing, exiting now')
    exit()
else:
    LOG_CHANNEL = int(LOG_CHANNEL)
FORCE_SUB_CHANNELS = [int(fsub_channels) if fsub_channels.startswith("-") else fsub_channels for fsub_channels in environ.get('FORCE_SUB_CHANNELS', '-1002669990791').split()]
if len(FORCE_SUB_CHANNELS) == 0:
    print('Info - FORCE_SUB_CHANNELS is empty')
    
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002662471092')
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', https://t.me/+oeEnBBTWFlgzMWI9'https://t.me/HA_Bots_Support')
UPDATES_LINK = environ.get('UPDATES_LINK', https://t.me/+TUBcfHFC46o4OGM1'https://t.me/HA_Bots')
FILMS_LINK = environ.get('FILMS_LINK', https://t.me/+URbl4-8gUgk2ZWM1'https://t.me/HA_Films_World')
